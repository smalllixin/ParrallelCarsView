...
@interface ViewController ()<WSwipeCardViewDelegate, WCardsShowViewDelegate>
...
//    _cardView.backgroundColor = [UIColor flatDarkBlackColor];
    ...
    [cs autoPinEdge:ALEdgeTop toEdge:ALEdgeBottom ofView:cardView withOffset:100];
    ...
    [cardView autoPinEdgeToSuperviewEdge:ALEdgeBottom withInset:500];
    cs.delegate = self;
    [cs reloadData];
